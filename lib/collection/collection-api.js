...
(() => {
  ...
  class CollectionApi {
    ...
    mapReduce(map, reduce, options) {
      return this._messageCenter.sendRequest(CollectionConstants.REQUEST.MAP_REDUCE, null, this._collectionName, map, reduce, {dbName: this._dbName, options: options});
    }
